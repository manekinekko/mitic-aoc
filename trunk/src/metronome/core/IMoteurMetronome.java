...
/**
 * Cette interface définit les méthodes à implémenter par la classe MoteurMetronome.
 * 
...
public interface IMoteurMetronome {
	...
	/**
	 * Méthode executée périodiquement via la commande "CommandeTic".
	 * Elle execute les commandes "CommandeMarquerTemps" et "CommandeMarqueurMesure".
	 * @since 1.0
	 */
